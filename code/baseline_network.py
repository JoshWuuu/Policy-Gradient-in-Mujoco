...
class BaselineNetwork(nn.Module):
    ...
    def forward(self, observations):
        ...
        output = self.network(observations).squeeze()  # [batch size]
        #######################################################
        #########          END YOUR CODE.          ############
    ...
    def calculate_advantage(self, returns, observations):
        ...
        baseline = self.forward(observations).detach().numpy()  # [batch size]
    ...
    def update_baseline(self, returns, observations):
        ...
        baseline = self.forward(observations)  # [batch size]
